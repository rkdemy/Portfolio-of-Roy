      ...
      <div className={styles.sticky_container}>
        ...
        <div className={styles.button_container}>
          ...
          <a
            ...
            target="_blank"
          >
            <button id={styles.second_button}>Github</button>
          </a>
        </div>
        ...
        <table>
          ...
          <tr>
            <td>Tech Stack</td>
            <td>Vite, JavaScript, TypeScript, Node.JS, Redux</td>
          </tr>
          <tr>
            <td>Database</td>
            <td>Firestore</td>
      ...
      <div className={styles.content}>
        ...
        <div>
          ...
          <p>
            ...
            themselves stuck in familiar genres and are unaware of the vast
            array of music available.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Develop a website that leverages users' Spotify playlists to help
            them discover new music genres. By analyzing the genres of songs in
            their playlists, the website can recommend related but unfamiliar
            genres.
          </p>
        </div>
        ...
        <div>
          ...
          <div id={styles.big_text}>
            Help users build more varied and interesting music libraries and
            enjoy a richer auditory experience.
          </div>
        </div>
        ...
        <div>
          ...
          <div id={styles.big_text}>
            For my idea to work I needed a database that shows how genres
            relate. For example, recognizing that <code>"rap"</code> and{" "}
            <code>"hip hop"</code> are closely related, while{" "}
            <code>"country music"</code> isn't.
          </div>
          <p>
            After searching for such a database with no luck, I almost gave up
            on my idea. But then, by pure chance, a friend told me about a
            website called Everynoise. It turned out to be just what I needed.
            It provided a scatterplot where similar genres were placed close to
            eachother. I found the coordinates (left and top) of each genre in
            the devtools HTML.
          </p>
          <p>
            Then it hit me—I could use these coordinates from the HTML devtools
            to create my own cluster database.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <p>
            I converted the HTML into a text file and then filtered it to
            extract only the top, left, and genre name. Using regex, I managed
            to isolate these values and saved them into a new file named{" "}
        ...
        <div>
          ...
          <p>
            ...
            course using R and RStudio. So, I downloaded them and began to
            cluster my newly created output file using K-means clustering.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <p>
            However, I noticed a flaw. K-means clustering requires a manual
            input for the number of clusters. With over 6000 genres, determining
            the optimal number of clusters became a challenge. I searched for
            clustering methods that could do this automatically.
          </p>

          <p>
            During my search, I stumbled on X-means clustering, a method
            proposed by Dan Pelleg and Andrew Moore. However, the software I
            employed was Weka, developed by a team led by Professor Ian H.
            Witten. It was nice to also know it was developed by our friends
            from across the pond New Zealand.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <p>
            ...
            and error I went back to K-means and settled with 20 clusters being
            a good balance.
          </p>
          <LazyLoad once>
            <img
        ...
        <div>
          ...
          <p>
            ...
            massive array every time. It'd be painfully slow. So, I split the
            data into two objects.
          </p>

          <p className={styles.tab}>
            I chose objects because JS in the backend will treat objects as hash
            maps meaning searches are speedier compared to looping through
            arrays.
          </p>
          <p>
            One object would use the genre as a key. So, when someone inputs{" "}
            <code>"pop"</code> I could quickly find the cluster number. The
            second object would have the cluster number as the key, containing
            all the genres associated to that cluster. This way, searching for
            details became much faster.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <div id={styles.big_text}>
            Next, I developed logic to extract the most common genres in the
            users playlist.
          </div>
          <p>
            ...
            playlist's "vibes". However, I abandoned this approach due to its
            high demand on the Spotify API. To ensure accurate recommendations,
            it would've required requesting more songs than necessary requesting
            the songs features and only selecting the top 10 or 20 most similar
            songs.
          </p>

          <p>
            Ultimately, I believed this method was too wasteful and opted to
            sort songs based on their popularity, striking a balance between
        ...
        <div>
          ...
          <p>
            ...
            forwarded them to the server for further processing. With each
            genre, I queried the Genre Object to locate its corresponding
            cluster.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <p>
            Once I had the cluster, I searched for it within the Cluster Object
            to retrieve all the genres in the same cluster. I then obtained the
        ...
        <div>
          ...
          <p>
            Afterwards I map the contents of the object and calculate the
            distance of every genre to the initial coordinates. I then sort it
            by distance allowing the code to return the nth nearest genre.
          </p>
          <LazyLoad once>
        ...
        <div>
          ...
          <p>
            My design inspiration was designed by lazy kar for LazyInterface UI
            UX Team
          </p>
          <LazyLoad once>
            <img
        ...
        <div>
          ...
          <p>
            Furthermore, I opted for a darker theme instead of a white
            background, as I often coded at night and being flash banged is not
            fun.
          </p>
          <LazyLoad once>
            <img
        ...
        <div>
          ...
          <p>
            ...
            player to maximize screen space and display a larger number of
            songs. Enlarging the images improved accessibility, while
            highlighting three songs had attention-grabbing elements. Moreover,
            reducing the opacity of other songs allowed users to view multiple
